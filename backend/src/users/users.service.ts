  ...
  async updateUser(id_user: number, user: UsersDto) {
    try {
      ...
      return await this.dataSource
        .getRepository(UsersEntity)
        .update({ id_user: userFind.id_user }, user);
    } catch (error) {
      throw new HttpException(
    ...
    try {
      ...
      if (userFind) {
        ...
        return {
          ...
          apPat: userFind.apPat,
          apMat: userFind.apMat,
          correo: userFind.correo,
          area: userFind.area,
          puesto: userFind.puesto,
        };
      }
      ...
      if (adminFind) {
        ...
        return {
          id: adminFind.id_admin,
          nombre: adminFind.nombre,
          apPat: adminFind.apPat,
          apMat: adminFind.apMat,
          correo: adminFind.correo,
        };
      }
